                ...
                <div className="space-y-6">
                   <div className="flex justify-between items-center text-[10px] font-black text-slate-500 uppercase tracking-widest">
                    ...
                    <div className="flex bg-slate-900 p-1 rounded-xl border border-slate-800">
                      <button onClick={() => setFileMode('link')} className={`px-4 py-1.5 rounded-lg transition-all text-[10px] font-black uppercase tracking-widest ${fileMode === 'link' ? 'bg-indigo-600 text-white' : 'text-slate-500'}`}>Link</button>
                      <button onClick={() => setFileMode('upload')} className={`px-4 py-1.5 rounded-lg transition-all text-[10px] font-black uppercase tracking-widest ${fileMode === 'upload' ? 'bg-indigo-600 text-white' : 'text-slate-500'}`}>Binary</button>
                    </div>
                   </div>
